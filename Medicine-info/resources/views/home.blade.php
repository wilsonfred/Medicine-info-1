...
<html>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 col-md-push-2 counter-wrap">
					<div class="row">
						<div class="col-md-3 col-sm-6 animate-box" style="float: right;">
							<div class="desc">
								<p class="wrap">
								...
								<span class="colorlib-counter-label">Medicines Data</span>
							</div>
						</div>
                    ...
                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                     <div class="panel panel-default">
                         ...
                         <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                             <div class="panel-body">
                                 <div class="row">
								      		<div class="col-md-6">
								      			<p> 1. Give all the info about the medicine accurately </p>
								      		</div>
								      		<div class="col-md-6">
								      			<p>2. Make sure the medicine is up 2 date</p>
								      		</div>
								      	</div>
                             </div>
                         </div>
                     ...
                     <div class="panel panel-default">
                         ...
                         <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                             <div class="panel-body">
                                 <p>Become the best website that provide all the info about medicine up to date and trusted</p>
                             </div>
                         </div>
                     </div>
                     <div class="panel panel-default">
	...
	<div id="colorlib-choose">
		<div class="container-fluid">
			<div class="row">
				<div class="choose">
					<div class="half img-bg" style="background-image: url(images/medicine-11111.jpg);"></div>
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-12 colorlib-heading">
					<h2>Our Visitors and their opinions</h2>
				</div>
			</div>
			<div class="row">
