...
<body>
    ...
    <div style=" margin-left:0%; margin-top:0.5%;">
        ...
        <br><br>
        <h1>Your Drug is Original!</h1><br>
        <p>We compare your drug to our database and your drug is still on our data! <br> which mean that your drug is originaly from the trusted distributor</p>
