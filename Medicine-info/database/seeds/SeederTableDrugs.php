    ...
    public function run()
    {
        //
         ...
         $arrdrugs = array(
            ...
            array('Id'=>'8','Name'=>'Ancla','ImageUrl'=>'8.jpg','Desc'=>'Ancla forte memiliki efektif untuk mengatasi infeksi saluran nafas, kulit dan jaringan, saluran kemih, tulang dan sendi, serta infeksi lainnya.','Brand'=>'Ancla (MEPROFARM)','Type'=>'Antibiotika','AvgPrice'=>'Rp 89.458,- / Botol','General'=>' Ancla sirup forte diproduksi oleh PT. Meprofarm dan telah terdaftar pada BPOM. Ancla forte disajikan dalam bentuk sirup kering yang perlu ditambahkan air hingga batas yang tertera pada botol dan kocok dahulu sebelum diberikan pada pasien. Ancla forte pada setiap 5ml nya mengandung 250mg amoxicilin trihydrate dan 62,5mg K clavulanat. Kombinasi dari kandungan tersebut efektif untuk mengatasi infeksi saluran nafas, kulit dan jaringan, saluran kemih, tulang dan sendi, serta infeksi lainnya.','created_at'=>DB::raw('NOW()')),
         
            array('Id'=>'9','Name'=>'Clanexi forte','ImageUrl'=>'9.jpg','Desc'=>'Clanexi merupakan antibiotik kombinasi yang digunakan untuk mengatasi infeksi pada saluran pernafasan atas, infeksi saluran kemih, saluran cerna, kulit dan jaringan lunak. ','Brand'=>'Clanexi forte(sanbe farma)','Type'=>'Antibiotika','AvgPrice'=>'Rp 16.043,- / Tablet','General'=>'Clanexi merupakan antibiotik kombinasi yang digunakan untuk mengatasi infeksi pada saluran pernafasan atas, infeksi saluran kemih, saluran cerna, kulit dan jaringan lunak. Claneksi mengandung kombinasi Amoksisilin (antibiotik golongan beta-laktam) dengan Asam Klavulanat (penghambat enzim beta-laktamase) yang disebut coamoxiclav. Coamoxiclav bersifat bakteriolitik yang bekerja dengan cara menghambat sintesis dinding sel bakteri dengan memutus rantai polimer peptidoglikan sehingga tidak terbentuk. Kombinasi ini bertujuan untuk meningkatkan efektivitas antibiotik terhadap bakteri-baketri yang memproduksi beta-laktamase yang resisten terhadap Amoksisilin.','created_at'=>DB::raw('NOW()')),
         
            array('Id'=>'10','Name'=>'Erysanbe','ImageUrl'=>'10.jpg','Desc'=>'Erysanbe merupakan antibiotik yang digunakan untuk mengatasi infeksi karena kuman yang peka terhadap eritromisin.','Brand'=>'Erysanbe (Sanbe)','Type'=>'Antibiotika','AvgPrice'=>'Rp 3.535,- / Tablet','General'=>'Erysanbe merupakan antibiotik yang digunakan untuk mengatasi infeksi karena kuman yang peka terhadap eritromisin.','created_at'=>DB::raw('NOW()')),
